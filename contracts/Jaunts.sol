...
contract Jaunts is Initializable, AccessControl {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of MOVRs
    ...
    function initialize(address admin, address operator)
        external
        initializer
    {
    ...
    function deposit(uint256 _pid, uint256 _amount) external payable onlyValidPool(_pid) {
        PoolInfo storage pool = poolInfo[_pid];
